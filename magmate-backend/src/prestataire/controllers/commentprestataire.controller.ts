import {
  ...
  export class CommentPrestataireController {
    constructor(private readonly commentPrestataireService: CommentPrestataireService) {}
    ...
    async getComments(@Param('prestataireId') prestataireId: string) {
      return this.commentPrestataireService.getCommentsByPrestataire(prestataireId);
    }
  }
